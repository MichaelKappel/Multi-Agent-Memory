...
def main(argv=None):
    ...
    requirements = [
        ...
        evidence_item(
            ...
            "pass_local",
            ["tests/test_app.py covers free account, hash boundary, registration, memory submit/search, firewall redaction, review queue, current-message, ack, receipts, fail-closed agent audit access, idempotency, and safe no-op errors"],
        ),
        evidence_item(
            "local_dogfooding",
