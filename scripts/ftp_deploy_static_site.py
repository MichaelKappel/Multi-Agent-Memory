...
def discover_remote_dir(host, user, password, port, fields, target_domain):
    report = {
        "attempted": False,
        "candidateCount": 0,
        "found": False,
...
def main(argv=None):
    ...
    if args.discover_remote_dir and not remote_dir:
        discovered_dir, discovery_report = discover_remote_dir(host, user, password, port, fields, args.target_domain)
