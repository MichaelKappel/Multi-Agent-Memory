...
class HumanAccountCompanyLifecycleContract:
    ...
    def test_password_account_links_multiple_companies_and_requires_explicit_selection(self):
        ...
        self.assertFalse(history["agentsCanAccess"])
        self.assertEqual(7, history["retentionDays"])
        self.assertTrue(history["physicallyDeletedAfterRetention"])
        self.assertEqual(len(history["items"]), history["count"])
