...
Report source snapshot: `963b93ba374003c709d85fb97e429de2e20e9cc5`. Tracked reports are point-in-time evidence; rerun the no-write live and CI verifiers after a final push to prove the current commit.
...
- Snapshot freshness at report generation: local route report `true`, package report `true`, GitHub CI report `false` for snapshot HEAD `963b93ba3740`.
...
- Live latest-code SHA verification snapshot: expected `7234135b80753ae29e1042727ac9955aa92b0b44`, observed `None`, match `false`.
...
```json
{
  ...
  "reportSourceSha": "963b93ba374003c709d85fb97e429de2e20e9cc5",
  "valuesRedacted": true
}
```
