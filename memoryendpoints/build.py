...
def _safe_build_info(data):
    ...
    return {
        ...
        "contentHash": data.get("contentHash") or data.get("content_hash"),
        "sourceWorktreeDirty": bool(data.get("sourceWorktreeDirty") or data.get("source_worktree_dirty")),
        "sourceDirtyPathCount": int(data.get("sourceDirtyPathCount") or data.get("source_dirty_path_count") or 0),
