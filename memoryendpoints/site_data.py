...
def connector_contract():
    ...
    return {
        ...
        "knowledgeWikiFlow": {
            ...
            "queryFilters": ["q", "scope", "scope_id", "category", "taxonomy_path", "taxonomy_prefix", "document_type", "knowledge_status", "authority_level", "source_prefix", "document_id", "include_text", "limit"],
