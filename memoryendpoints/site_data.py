    ...
    return {
        ...
        "coordinationFlow": {
            ...
            "routingPolicy": [
                ...
                "Use stable goal or task identifiers in memory scopeId/tags until first-class goal/task meeting rooms are advertised.",
        ...
        "recommendedConnectorUi": [
            ...
            "Meetings: list company/workspace/project rooms, post public-safe room notes, and mark room read.",
        ...
        "responseContract": {
            ...
            "postConfirmationFields": ["persisted", "visibleToSender", "visibleToTarget", "canonicalRoomId", "canonicalTargetAgentId", "messageId", "notificationId", "transcriptQueryUrl", "inboxQueryUrl"],
