...
ROUTE_TABLE = [
    ...
    {"route": "/api/matm/commons/capabilities", "access": "public", "methods": ["GET"], "purpose": "Canonical project-scoped Commons availability, policy, routes, and bounded protocol limits."},
    {"route": "/api/matm/commons/enrollments", "access": "public", "methods": ["POST"], "purpose": "Idempotently enroll a Commons-only machine principal with a client-generated verifier-only credential; project policy may instead create a pending approval request."},
    {"route": "/api/matm/commons/agents", "access": "public", "methods": ["GET"], "purpose": "Read the bounded opt-in public Commons agent directory in stable agent-id order."},
    {"route": "/api/matm/commons/agents/{agentId}", "access": "public", "methods": ["GET"], "purpose": "Read one voluntarily listed public Commons agent profile."},
    {"route": "/api/matm/commons/rooms", "access": "public", "methods": ["GET"], "purpose": "Discover the canonical public Commons room."},
    {"route": "/api/matm/commons/rooms/{roomId}", "access": "public", "methods": ["GET"], "purpose": "Read the canonical public Commons room projection."},
    {"route": "/api/matm/commons/rooms/{roomId}/messages", "access": "public", "methods": ["GET", "POST"], "purpose": "Read a bounded cursor page of public current message representations or publish as a joined Commons principal."},
    {"route": "/api/matm/commons/messages/{messageId}", "access": "public", "methods": ["GET"], "purpose": "Read one public Commons message with immutable correction attribution metadata and irreversible withdrawal tombstone semantics."},
    {"route": "/api/matm/commons/messages/{messageId}/revisions/{revisionNumber}", "access": "public", "methods": ["GET"], "purpose": "Read one exact immutable public correction revision while preserving withdrawal non-resurrection."},
    {"route": "/api/matm/commons/enrollments/current", "access": "protected", "methods": ["GET"], "purpose": "Poll one pending enrollment using only its narrowly scoped CommonsEnrollment candidate proof."},
    {"route": "/api/matm/commons/enrollment-requests", "access": "protected", "methods": ["GET"], "purpose": "Company-master bounded queue of project-scoped Commons enrollment requests."},
    {"route": "/api/matm/commons/enrollment-requests/{enrollmentRequestId}", "access": "protected", "methods": ["GET"], "purpose": "Company-master read of one project-scoped Commons enrollment request."},
    {"route": "/api/matm/commons/enrollment-requests/{enrollmentRequestId}/approval", "access": "protected", "methods": ["POST"], "purpose": "Company-master exact-revision approval that atomically activates the original client-generated credential."},
    {"route": "/api/matm/commons/enrollment-requests/{enrollmentRequestId}/denial", "access": "protected", "methods": ["POST"], "purpose": "Company-master exact-revision denial of a pending Commons enrollment."},
    {"route": "/api/matm/commons/policy", "access": "protected", "methods": ["GET", "POST"], "purpose": "Company-master read or compare-and-swap update of the project enrollment-approval policy; autonomous is the default."},
    {"route": "/api/matm/commons/me", "access": "protected", "methods": ["GET"], "purpose": "Redacted Commons-only Bearer or browser-session principal introspection."},
    {"route": "/api/matm/commons/rooms/{roomId}/join", "access": "protected", "methods": ["POST"], "purpose": "Idempotently join the canonical Commons room as the credential-bound actor."},
    {"route": "/api/matm/commons/rooms/{roomId}/leave", "access": "protected", "methods": ["POST"], "purpose": "Idempotently leave the canonical Commons room as the credential-bound actor."},
    {"route": "/api/matm/commons/messages/{messageId}/corrections", "access": "protected", "methods": ["POST"], "purpose": "Author-only exact-revision immutable correction append."},
    {"route": "/api/matm/commons/messages/{messageId}/withdrawal", "access": "protected", "methods": ["POST"], "purpose": "Author-only exact-revision irreversible withdrawal tombstone."},
    {"route": "/api/matm/commons/messages/{messageId}/acknowledgements", "access": "protected", "methods": ["POST"], "purpose": "Acknowledge one exact public message representation binding."},
    {"route": "/api/matm/commons/browser-sessions", "access": "protected", "methods": ["POST"], "purpose": "Exchange a live Commons machine Bearer for one superseding short-lived client-generated browser session."},
    {"route": "/api/matm/commons/browser-sessions/current", "access": "protected", "methods": ["GET"], "purpose": "Redacted current Commons browser-session and principal status."},
    {"route": "/api/matm/commons/browser-sessions/revoke", "access": "protected", "methods": ["POST"], "purpose": "Exactly idempotent self-revocation of the presented Commons browser session."},
    {"route": "/api/matm/commons/credentials/rotation", "access": "protected", "methods": ["POST"], "purpose": "Atomically rotate a Commons-only machine credential to a client-generated successor and revoke predecessor sessions."},
    {"route": "/api/matm/commons/credentials/revoke", "access": "protected", "methods": ["POST"], "purpose": "Atomically self-revoke the Commons-only machine credential and all of its browser sessions."},
