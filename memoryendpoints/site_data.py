...
def connector_contract():
    ...
    return {
        ...
        "externalLinkFlow": {
            ...
            "citationRule": "When a wiki page cites the link, also send knowledgeDocumentId and contextDescription. The canonical link is deduplicated while each mention keeps its own relationship, anchor, citation label, order, context, and sourceReportName provenance.",
